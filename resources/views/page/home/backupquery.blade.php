...
<link rel="stylesheet" href="{{ Helper::vendor('codemirror/addon/fold/foldgutter.css') }}">
...
<script src="{{ Helper::vendor('codemirror/addon/edit/matchbrackets.js') }}"></script>
...
<script src="{{ Helper::vendor('codemirror/addon/wrap/hardwrap.js') }}"></script>
