@extends('backend.'.config('website.backend').'.layouts.filemanager')

@push('style')
<style type="text/css" media="screen">

    .sidebar-left, .page-header, .sidebar-toggle{
...
<div id="editor" class="row">
    ...
    <textarea name="code" id="code" cols="30" rows="10">{{ $data }}</textarea>
...
<script>
     ...
     function createEditor(name) {
        ...
        // create ace editor 
        var editor = ace.edit()
        var height = $(".sidebar-left").height()+200;
