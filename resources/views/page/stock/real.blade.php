...
<div class="row">
    <div class="panel-body">
        ...
        {!! Form::open(['route' => $form.'_real', 'id' => 'search-form', 'files' => true]) !!}
        ...
        {!! Form::open(['route' => 'stock_warehouse_real', 'id' => '', 'files' => true]) !!}  
                    ...
                    <table id="datatable" class="table table-bordered table-condensed table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                @endforeach
                                <td style="min-width: 10%;" class="text-center"><strong>Actions</strong></td>
                            </tr>
                        </thead>
                    </table>
                </diV>
