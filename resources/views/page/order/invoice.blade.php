                        ...
                        <table border='0.4' cellpadding='5' cellspacing='0' id='templateList' width='100%'>
                            ...
                            <tr>
                                ...
                                <td align='right' colspan='1' valign='middle'>
                                    {{ round($d->qty_prepare) }} {{ $d->product_unit }}
                                </td>
                                <td align='right' colspan='1' valign='middle'>
                                    <strong>
                            ...
                            @endforeach
                             <tr>
                                <td align='left' colspan='7' valign='middle'>
                                    <strong>Real Pengiriman</strong>
                                </td>
                                <td align='right' colspan='1' valign='middle'>
                                    <strong>
                                        <span class='currency positive'>Rp.</span><span class='amount positive'> {{ number_format($data->delivery_cost) }},-</span>
                                    </strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align='right' colspan='1' valign='middle'>
                                    <strong>
                                        <span class='currency positive'>Rp.</span><span class='amount positive'> {{ number_format($total) }},-</span>
                                    </strong>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td align='right' colspan='1' valign='middle'>
                                    <strong>
                                        <span class='currency positive'>Rp.</span><span class='amount positive'> {{ number_format($total + $data->delivery_cost) }},-</span>
                                    </strong>
                                </td>
                            </tr>
                        </tr>
