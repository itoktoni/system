...
<div class="row">
    <div class="panel-body">
        ...
        {!! Form::open(['route' => $form.'_'.$action, 'id' => 'search-form', 'files' => true]) !!}
                    ...
                    <table id="datatable" class="table table-bordered table-condensed table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <td width="65" class="text-left"><strong>Tgl Order</strong></td>
                                <td width="80" class="text-left"><strong>Tgl Kirim</strong></td>
                                ...
                                <td width="{{ session('button')*55 }}" class="text-center"><strong>Actions</strong></td>
                            </tr>
                        </thead>
                    </table>
                </diV>
