        ...
        <div>
            <div style="margin-bottom: 20px;clear: both;">
                <h4 style='text-align: center; color:white;line-height: 0;font-size: 1.2em; font-weight: bold;'>
                    RECEIVE PURCHASE ORDER ( {{ $data->purchase_id }} )
                </h4>
                    ...
                    <div style="margin-top: 40px;">    
                        <table border='0.4' cellpadding='5' cellspacing='0' id='templateList' width='100%'>
                            ...
                            <tr>
                                ...
                                <td align='left' colspan='6' valign='top'>
                                    <strong>
                                        {{ date_format(date_create($data->purchase_receive_date),"d F Y") }}
                                    </strong>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align='right' colspan='1' valign='middle'>
                                    <strong>
                                        <span class='currency positive'></span><span class='amount positive'> {{ $d->qty_receive }},-</span>
                                    </strong>
                                </td>
                                <td align='right' colspan='1' valign='middle'>
                                    <strong>
                                        <span class='currency positive'></span><span class='amount positive'> {{ $d->qty_receive - $d->qty_prepare }},-</span>
                                    </strong>
                                </td>
                            </tr>
                            @endforeach
                            ...
                            <tr>
                                <td align='left' colspan='7' valign='top'>
                                    <strong>TOTAL YANG DITERIMA</strong>
                                </td>
