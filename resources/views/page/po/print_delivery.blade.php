                            ...
                            <div style="margin-top: 30px;">     
                                <table border='0.4' cellpadding='5' cellspacing='0' id='templateList' width='100%'>
                                    ...
                                    <tr>
                                        ...
                                        <td align='right' width="250px;" colspan='2' style='background-color: #e0e0e0 !important' valign='top'>
                                    ...
                                    @foreach($detail as $d)
                                    @php
                                    $sub_total =  $d->qty_prepare;
                                    $urut = $urut +1;
                                    $total = $total + $sub_total;
                                    @endphp
                                    <tr>
                                        <td align='left' width="20" colspan="1" valign='middle'>
                                  ...
                                  <tr>
                                    ...
                                    <td align='right' class='grandTotal' colspan='1' valign='top'>
                                        <strong><span class='currency positive'></span><span class='amount positive'> {{ $total }}</span></strong>
                                    </td>
                                </tr>
                            </tr>
                        </table>
