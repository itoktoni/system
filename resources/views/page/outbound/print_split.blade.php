...
<body>
    <div id='page'>
        <div style="margin-bottom: 0px;margin-top:-35px;clear: both;">
            ...
            <img style="margin-top: 25px;width: 100%; text-align: center;" src="data:image/png;base64,{{BARCODE1D::getBarcodePNG($data->barcode.'#'.$data->product_id.'#'.$data->qty, 'C128')}}" alt="barcode" />

            <h5 style='text-align: center; padding-top:10px;color:white;line-height: 0;font-size: 1em; font-weight: bold;'>
                {{ $data->product_name }}
            </h5>
            <p style="text-align: center;padding-top: 10px;">Barcode ( {{ $data->barcode }} )</p>
        </div>
