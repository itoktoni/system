...
<script>
    ...
    $(function() {
        ...
        var oTable = $('#datatable').DataTable({
            ...
            columns: [
            {data: 'purchase_id', name: 'purchase_id', searchable: false},
            {data: 'purchase_date', name: 'purchase_date', searchable: false},
            {data: 'purchase_delivery_date', name: 'purchase_delivery_date', searchable: false},
            {data: 'supplier_name', name: 'supplier_name', searchable: false},
            {data: 'purchase_status', name: 'purchase_status', searchable: false},
    ...
    <div class="row">
        <div class="panel-body">
            ...
            <header class="panel-heading">
                <h2 class="panel-title">Form Order Supplier</h2>
            </header>
                        ...
                        <table id="datatable" class="table table-bordered table-condensed table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <td width="110" class="text-center"><strong>Tgl Kirim</strong></td>
                                    <td class="text-left"><strong>Nama Supplier</strong></td>
                                    ...
                                    <td style="min-width:100px;" class="text-center"><strong>Actions</strong></td>
                                </tr>
                            </thead>
                        </table>
                    </diV>
