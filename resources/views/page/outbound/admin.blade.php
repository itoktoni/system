...
@section('content')
<div class="row">
    {!! Form::model($data, ['route'=>[$form.'_admin', $data->$key],'class'=>'form-horizontal','files'=>true]) !!}
                ...
                <header class="panel-heading">
                    ...
                    <tr>
                        ...
                        <td class="text-right col-md-2">
                            <input type="text" name="qty[]" class="form-control text-right input-sm" value="{{ $c->qty }}">
                        </td>
                        <td class="text-right col-md-2">
                            <input type="text" name="price[]" class="form-control text-right input-sm" value="{{ $c->price }}">
                        </td>
