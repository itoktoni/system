    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="table-responsive">
                ...
                <header class="panel-heading">
                    <h2 class="panel-title text-right">Update Supplier</h2>
                </header>
        ...
        <div class="navbar-fixed-bottom" id="menu_action">
            <div class="text-right" style="padding:5px">
                ...
                @endisset
                @isset($approve)
                <a target="_blank" href="{!! route("{$form}_approve", ["code" => $data->$key]) !!}" class="btn btn-danger">Cetak PDF
                </a>
                @endisset
                 @isset($deliver)
                <a target="_blank" href="{!! route("{$form}_deliver", ["code" => $data->$key]) !!}" class="btn btn-danger">Cetak PDF
                </a>
                @endisset
            </div>
        </div>
