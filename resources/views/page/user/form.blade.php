                    ...
                    <div id="collapse1One" class="accordion-body collapse in">
                        <div class="panel-body">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Sales Responsible</label>
                                    <div class="col-md-4">
                                        <select class="form-control input-sm mb-md" id="sales" name="sales_responsible">
                                            @foreach($user as $u)
                                            <option {{ $u->user_id == $model->sales_responsible ? "selected" : "" }}  value="{{ $u->user_id }}">{{ $u->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
