                ...
                <div class="panel panel-sign">
                    <div class="panel-body"> 
                        <div class="current-user text-center">
                            <img src="{{ Helper::files('logo/default_error.png') }}" class="img-circle user-image" />

                        </div>

                        <div class="form-group mb-lg">
                            <div class="input-group input-group-icon">
                                <h1 class="user-name text-center text-danger m-none">Error 404 !</h1>
                                <br>
                                <h4 class="user-email text-center text-dark m-none"> 
                                    Page Not Found !
                                </h4>
                                <hr>
                            </div>
